...
// will need name, age, make/model, gender, yes/no to moving violations, credit score, and the calculated monthly insurance rate

        // create our variables
        String firstPersonName = "Susie";
        String secondPersonName = "Jared";
        ...
        int firstPersonCreditScore = 720;
        int secondPersonCreditScore = 650;
        ...
        // if you have traffic tickets, DUIs, other violations, your insurance rate is higher
        // poor credit score also increases insurance rate
...
// will gender and age make a difference? yes, of course it does. boys are dumbos.
        ...
        System.out.println("Second Person Final Monthly Rate: "+total2);
    }
